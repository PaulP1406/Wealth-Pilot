    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <nav className="flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-md border-b border-gray-200 sticky top-0 z-50">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-gray-900">Co-Author</span>
        </div>
      ...
      <section className="px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Upload your rubric, paste your essay, and get instant AI-powered feedback with detailed scoring and improvement suggestions.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">Upload Rubric</h3>
              <p className="text-gray-600">Simply upload your assignment rubric or paste the requirements directly.</p>
            </div>
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">Paste Your Essay</h3>
              <p className="text-gray-600">Copy and paste your essay into our intelligent analysis system.</p>
            </div>
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Receive detailed scoring and specific suggestions for improvement.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of students who are already getting better grades with AI-powered writing assistance.
          </p>
      ...
      <footer className="px-6 py-12 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">Co-Author</span>
              </div>
              <p className="text-gray-400">
                AI-powered writing assistance to help you achieve better grades and improve your writing skills.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Co-Author. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
